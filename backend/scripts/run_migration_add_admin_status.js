#!/usr/bin/env node
// Safe migration runner: adds status and is_banned to yshopadmins if missing
...
async function run() {
  try {
    ...
    if (!hasIsBanned) {
      logger.info('Adding column `is_banned` to yshopadmins');
